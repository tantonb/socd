...
public class FlatChunkGenerator extends ChunkGenerator {
    public static final Codec<net.minecraft.world.gen.FlatChunkGenerator> field_236069_d_ = FlatGenerationSettings.field_236932_a_.fieldOf("settings").xmap(net.minecraft.world.gen.FlatChunkGenerator::new, net.minecraft.world.gen.FlatChunkGenerator::func_236073_g_).codec();
